<template>
    <div class="p-6 text-center">
        ...
        <h3 class="font-sans text-xl font-normal text-black dark:text-gray-400">Are you sure you want to delete this Article?</h3>
        <button @click="deleteArticle" data-modal-hide="popup-modal" type="button"
...
export default defineComponent({
    ...
    methods: {
        deleteArticle() {
            ...
            this.$api.delete('admin/articles/delete', {

                params: {

                    id: this.article.hash
                }
            })
                .then((response) => {
                    
                    notify({ group: "main", title: "article deleted", type: "positive" }, '3000')
                })
            this.$emit('done')
        },
        cancel() {
