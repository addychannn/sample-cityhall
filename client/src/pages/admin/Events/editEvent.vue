<template>
    <Page class="p-5 w-full">
        ...
        <Modal :show="componentOptions.showModal" @close="closeModal">
            <ConfirmDeleteEventImage v-if="componentOptions.showModal" @proceed="deleteImage" @cancel="closeModal"/>
        </Modal>
        <div class="flex flex-col ">
            ...
            <div class="flex flex-row items-start justify-start">
                <div class="flex   pr-2 text-slate-800 p-2">
                    ...
                    <span class="font-sans text-5xl font-semibold flex flex-col items-center justify-center">EDIT
                        EVENT</span>
...
import ConfirmDeleteEventImage from '@/pages/admin/Events/confirmDeleteImage.vue'
...
export default defineComponent({
    ...
    methods: {
        ...
        async submit() {
            ...
            this.$api.patch('admin/events/EditEvent/',changes)
            .then((response)=>{
                notify({group:"main", title:"Event Updated!", type:"positive"},'3000')
        ...
        async addImage(){
            let token = null
            token = this.event.hash
           
            if(this.newFiles.length != 0 ){
                this.componentOptions.innerLoading.text = "Adding photos,please wait"
         ...
         async uploadImage(hash, files) {
            ...
            for (let i = 0; i < files.length; i++) {
                ...
                await this.$api.post('EditEvent/create/photo', formData)
        ...
        async deleteImage(){
            ...
            if(this.deleteFiles.length != 0){
                ...
                for(let i=0; i<this.deleteFiles.length; i++){
                    ...
                    this.$api.delete('/EditEvent/delete/photo',{
                        params:{
                            id: img
                        }
                    })
