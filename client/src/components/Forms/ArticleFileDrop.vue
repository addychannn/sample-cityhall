      ...
      >
        ...
        <div class="hidden md:flex flex-col">
          ...
          <div class="leading-none transition-all hidden md:flex flex-col">
            <span class="font-sans">Drag N' Drop Files here</span>          
          </div>
          <div
            class="transition-all hidden md:flex flex-col font-sans"
            :class="[files.length > 0 && 'flex-auto text-center']"
          >
            OR
          </div>
          <div
            class="cursor-pointer rounded-full border border-slate-500/50 px-3 hover:bg-slate-500/50 hover:text-white transition-all flex flex-col font-bold font-sans"
